...
namespace UC_alert_tool.Controllers
{
    public class StoringenController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Titel,eigenaarID,begindatum,einddatum,isGesloten")] Storing storing)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Titel,eigenaarID,begindatum,einddatum,isGesloten")] Storing storing)
        {
            if (ModelState.IsValid)
            {
